    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.zoom.ZoomTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class ZoomTask extends Task implements RunnableTask<ZoomTask.Output> {
    @Schema(
    ...
    @Override
    public ZoomTask.Output run(RunContext runContext) throws Exception {
